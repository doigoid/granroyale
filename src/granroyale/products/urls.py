...
info_dicts = {
    ...
    'mens_bikes': models.CompleteBike.objects.public().filter(classification__name__istartswith="men"),
    'womens_bikes': models.CompleteBike.objects.public().filter(classification__name__istartswith="women"),
